...
const admin = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-Um_gwZdg.mjs").then((mod) => ({ default: mod.Upload })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-CardN-_x.mjs");
...
//# sourceMappingURL=index-DZWFLVGE.mjs.map
