...
const ListView$1 = lazy(() => import("./ListView-QeQPgjwX.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-QeQPgjwX.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-cD82V-TB.mjs.map
