...
const WebhookForm = ({ handleSubmit, triggerWebhook, isCreating, isTriggering, triggerResponse, data })=>{
    ...
    const EventTable = useEnterprise.useEnterprise(EventTableCE, async ()=>(await Promise.resolve().then(function () { return require('./EventsTable-B1ytvu7n.js'); })).EventsTableEE);
    /**
...
//# sourceMappingURL=EditPage-BLnONQN3.js.map
