    ...
    register (app) {
        if (window.strapi.features.isEnabled(FEATURE_ID)) {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { Router } = await Promise.resolve().then(function () { return require('./router-Cc8VcSCc.js'); });
                    return {
                        default: Router
                    };
                }
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseReviewWorkflows } = await Promise.resolve().then(function () { return require('./purchase-review-workflows-BQL0PbmB.js'); });
                    return {
...
//# sourceMappingURL=index-CEABZUwQ.js.map
