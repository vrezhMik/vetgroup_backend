...
const ListView = /*#__PURE__*/ lazy(()=>import('./ListView-Cl-pbcxP.mjs'));
const App = ()=>{
    const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-Knq4Ti8R.mjs.map
