...
var dependencies = {
    ...
    "@strapi/provider-upload-local": "5.11.1",
    "@strapi/utils": "5.11.1",
    "byte-size": "8.1.1",
    cropperjs: "1.6.1",
    "date-fns": "2.30.0",
...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>Promise.resolve().then(function () { return require('./App-Cviv4LUv.js'); }).then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await Promise.resolve().then(function () { return require('./SettingsPage-q1CNW5FB.js'); });
                return {
...
//# sourceMappingURL=index-DVQTOPLi.js.map
